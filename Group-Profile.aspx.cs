...
public partial class Group_Profile : System.Web.UI.Page
{
    ...
    private void BindSubjectList()
    {
        ...
        if (Convert.ToString(ViewState["intGroupId"]) != "" && Convert.ToString(ViewState["intGroupId"]) != null) 
        {
            objgrp.inGroupId = Convert.ToInt32(ViewState["intGroupId"]);
        }
        else
        ...
        {
            divlstProfSubjCategory.Visible = false;
    ...
    protected void GenaralGroupDetails()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                ViewState["join"] = "A";
                hdnAutoreqJoin.Value = "1";
                imgAutojoin.Attributes["src"]= "images/checked2.png";
                imgReqjoin.Attributes["src"] = "images/unchecked2.png";
            }
            else
            {
                ViewState["join"] = "R";
                hdnAutoreqJoin.Value = "2";
                imgAutojoin.Attributes["src"] = "images/unchecked2.png";
                imgReqjoin.Attributes["src"] = "images/checked2.png";
            }
        ...
        if (e.CommandName == "Subject Category")
        {
            ...
            if (ViewState["SubjectCategory"] != null)
            {
                ...
                if (dtsub.Rows.Count > 0)
                {
                    ...
                    SubLi.Style.Add("background", "#0288d1 !important");
    ...
    protected void getInviteNameEdit()
    {
        ...
        List<string> inviteSelected = new List<string>();
        ...
        if (dtJoin.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < Joins.Length; i++)
            {
                ...
                if (selectedvalue != "")
                {
                    inviteSelected.Add(selectedvalue);
                }
            }
        }
        ...
        txtInviteMember.SetValues(inviteSelected.ToArray());
    }
    #endregion
