...
public partial class forum_detail : System.Web.UI.Page
{
    ...
    protected void lstForumDetails_ItemDatabound(object sender, ListViewItemEventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //if (TotalLike == 1)
            //{
            //    lblTotallike.Text = Convert.ToString(TotalLike) + " Like";
            //}
            //else
            //{
            //    lblTotallike.Text = Convert.ToString(TotalLike) + " Likes";
            //}
            //if (TotalReply == 1)
            //{
            //    lblreply.Text = Convert.ToString(TotalReply) + " Reply";
            //}
            //else
            //{
            //    lblreply.Text = Convert.ToString(TotalReply) + " Replies";
            //}
            //if (TotalShare == 1)
            //{
            //    lblShare.Text = Convert.ToString(TotalShare) + " Share";
            //}
            //else
            //{
            //    lblShare.Text = Convert.ToString(TotalShare) + " Shares";
            //}
    ...
    protected void lnkDeleteConfirm_Click(object sender, EventArgs e)
    {
        if (ViewState["hdnForumPostId"] != null)
        {
            ...
            Response.Redirect("forum-landing-page.aspx?DeleteForum=true&GrpId=" + ViewState["intGroupId"]);
        }
        else
        {
    ...
    protected void BindlstReplyForum()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            //int ReplyCount = Convert.ToInt32(dt.Rows[0]["intForumReplyLikeShareId"]);
            //if (ReplyCount > 0)
            //{
            totalreplies.Visible = true;
            totalreplies.InnerText = Convert.ToString(dt.Rows.Count) + ((dt.Rows.Count == 1) ? " Reply" : " Replies");
            //}
            //else
            //{
            //    totalreplies.Visible = false;
            //}
    ...
    {
        //Label lblTotallike = (Label)e.Item.FindControl("lblTotallikes");
        ...
        if (hdnRegid.Value == UserID)
        {
            lnkEdit.Visible = true;
            lnkDelete.Visible = true;
            spanCmntsEditDelete.Visible = true;
        }
        else
        {
            lnkEdit.Visible = false;
        ...
        HiddenField hdnForumPostId = (HiddenField)e.Item.FindControl("hdnForumPostId");
        LinkButton btnLike = (LinkButton)e.Item.FindControl("btnLikes");
