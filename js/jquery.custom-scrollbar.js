    ...
    $.fn.customScrollbar = function (options, args) {
        ...
        Scrollbar.prototype = {
            ...
            resize: function () {
                ...
                // alert(this.overviewSize); alert(this.viewPortSize);
                // this.overviewSize = 7000;
                this.ratio = this.viewPortSize / this.overviewSize;
                this.sizing.size(this.$scrollBar, this.viewPortSize);

                this.thumbSize = Math.round(this.ratio * this.viewPortSize);
//                if (this.thumbSize == 504) {
//                    this.thumbSize = 12;
//                }

                   if (this.thumbSize == 392) {
                    this.thumbSize = 12;
                 }
            ...
            rescroll: function () {
                debugger;
                //var thumbPosition = this.scrollPercent * 825;
                var thumbPosition = this.scrollPercent * this.maxThumbPosition;
                //alert(this.maxThumbPosition);
            ...
            calculateMaxThumbPosition: function () {
                debugger;
                //                alert(this.sizing.size(this.$scrollBar));
                //                alert(this.thumbSize);
                //                alert(this.sizing.size(this.$scrollBar) - this.thumbSize);

                return this.sizing.size(this.$scrollBar) - this.thumbSize;

                //return this.sizing.size(this.$scrollBar) - 50;
            ...
            calculateMaxOverviewPosition: function () {
                debugger;
                //                alert(this.sizing.size(this.scrollable.$overview));
                //                alert(this.sizing.size(this.scrollable.$viewPort));
                //                alert(this.sizing.size(this.scrollable.$overview) - this.sizing.size(this.scrollable.$viewPort));
//                if (this.sizing.size(this.scrollable.$overview) == 1400) {
//                    return 4000 - this.sizing.size(this.scrollable.$viewPort);
//                }

                if (this.sizing.size(this.scrollable.$overview) == 1800) {
                    return 5200 - this.sizing.size(this.scrollable.$viewPort);
                }
