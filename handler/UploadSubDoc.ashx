<%@ WebHandler Language="C#" Class="UploadSubDoc" %>

using System;
using System.Web;
using System.IO;

public class UploadSubDoc : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.Files.Count > 0)
        {
            ...
            foreach (string key in files)
            {
                ...
                if (ext.Trim() != ".pdf" && ext.Trim() != ".doc" && ext.Trim() != ".docx")
                ...
                else
                {
                    ...
                    string directory = context.Server.MapPath("~\\SubDoc\\");
