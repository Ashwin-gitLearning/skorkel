...
{
    public class DO_Scrl_UserFollowInstitute
    {
        public DO_Scrl_UserFollowInstitute()
        {
            //
        ...
        private int _intInstituteUserId;
        ...
        public int intInstituteUserId { get { return _intInstituteUserId; } set { _intInstituteUserId = value; } }
