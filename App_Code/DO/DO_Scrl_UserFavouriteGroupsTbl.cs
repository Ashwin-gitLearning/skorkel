...
{
    public class DO_Scrl_UserFavouriteGroupsTbl
    {
        public DO_Scrl_UserFavouriteGroupsTbl()
        {
            //
        ...
        private int _intGroupFavouriteId;
        ...
        public int intGroupFavouriteId { get { return _intGroupFavouriteId; } set { _intGroupFavouriteId = value; } }
