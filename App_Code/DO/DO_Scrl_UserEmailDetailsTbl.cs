...
{
    public class DO_Scrl_UserEmailDetailsTbl
    {
        public DO_Scrl_UserEmailDetailsTbl()
        {
            //
        ...
        public int intEmailId { get { return _intEmailId; } set { _intEmailId = value; } }
