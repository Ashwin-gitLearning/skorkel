...
/// <summary>
/// Summary description for DA_DocumentRatio
/// </summary>
namespace DA_SKORKEL
{

    public class DA_DocumentRatio
    {
        public DA_DocumentRatio()
        {
            //
        ...
        public void AddEditDel_Ratio(DO_DocumentRatio objRatio, DA_DocumentRatio.DocumentRatio flag)
        {
            ...
            cmd = new SqlCommand("Scrl_AddEditDelRatioDoc", conn);
        ...
        public DataTable GetDataTable(DO_DocumentRatio objRatio, DA_DocumentRatio.DocumentRatio flag)
        {
            ...
            da.SelectCommand = new SqlCommand("Scrl_AddEditDelRatioDoc", conn);
