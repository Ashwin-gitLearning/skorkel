...
/// <summary>
/// Summary description for DA_DocumentFact
/// </summary>
namespace DA_SKORKEL
{
    public class DA_DocumentFact
    {
        public DA_DocumentFact()
        {
            //
        ...
        public void AddEditDel_Fact(DO_DocumentFact objFact, DA_DocumentFact.DocumentFact flag)
        {
            ...
            cmd = new SqlCommand("Scrl_AddEditDelFactDoc", conn);
        ...
        public DataTable GetDataTable(DO_DocumentFact objFact, DA_DocumentFact.DocumentFact flag)
        {
            ...
            da.SelectCommand = new SqlCommand("Scrl_AddEditDelFactDoc", conn);
