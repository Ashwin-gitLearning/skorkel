...
/// <summary>
/// Summary description for DA_DocumentLink
/// </summary>

namespace DA_SKORKEL
{
    public class DA_DocumentLink
    {
        public DA_DocumentLink()
        {
            //
        ...
        public void AddEditDel_Case(DO_DocumentLink objLink, DA_DocumentLink.DocumentLink flag)
        {
            ...
            cmd = new SqlCommand("Scrl_AddEditDelDocumentLink", conn);
        ...
        public DataTable GetDataTable(DO_DocumentLink objLink, DA_DocumentLink.DocumentLink flag)
        {
            ...
            da.SelectCommand = new SqlCommand("Scrl_AddEditDelDocumentLink", conn);
