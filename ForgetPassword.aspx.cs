...
public partial class ForgetPassword : System.Web.UI.Page
{
    ...
    protected void lnkGetPassword_Click(object sender, EventArgs e)
    {
        if (UserName.Text.Trim() != "")
        {
            ...
            else
            {
             ...
             //   lnkGetPassword.CssClass = "btn btn-primary w-200";
                UserName.Visible = true;
                lblErrorMsg.Text = "Invalid Login Id.";
                lblErrorMsg.CssClass = "RedErrormsg error_msz";
            }
        }
        else
        {
    ...
    private void SendMail(string To, string Link, string Name, char flag, string Details, string DistName)
    {
        ...
        try
        {
            ...
            body = body.Replace("{Content}", "You recently requested for a password.<br>" +
                   "Please keep the following information safely.<br>" +
                    "<b><br> Login Information</b><br>" +
                    "Password is : " + Details + "<br />");
                    //"<tr><td><br>Regards, <br>Skorkel Team</td></tr> ");
