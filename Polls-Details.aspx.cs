...
public partial class Polls_Details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["DeletePoll"] != null && Request.QueryString["DeletePoll"] != "")
            {
    ...
    protected void lstPollsDetails_ItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        //else if (Convert.ToInt32(lblVoters.Text) == 1)
        //    lblVoters.Text = lblVoters.Text + " Vote";
        //else
        //    lblVoters.Text = lblVoters.Text + " Votes";
    ...
    protected void chkRecent_CheckedChanged(object sender, EventArgs e)
    {
        ...
        hdnCurrentPage.Value = "1";
        hdnTotalItem.Value = "10";
        //LinkButton1.Style.Add("border-bottom", "2px solid #01579b");
        spanSelectedDropDown.InnerText = "Recent";
        LinkButton2.Style.Add("border-bottom", "none");
        BindAllPolls();
    }
    ...
    protected void chkActive_CheckedChanged(object sender, EventArgs e)
    {
        ...
        divCancelPoll.Style.Add("display", "none");
        divSuccessPolls.Style.Add("display", "none");
        //LinkButton2.Style.Add("border-bottom", "2px solid #01579b");
        spanSelectedDropDown.InnerText = "Active";
        hdnCurrentPage.Value = "1";
        hdnTotalItem.Value = "10";
        LinkButton1.Style.Add("border-bottom", "none");
    ...
    protected void imgLoadMore_OnClick(object sender, EventArgs e)
    {
        ...
        if (NextPage <= Convert.ToInt32(ViewState["MaxCount"]) || (Convert.ToInt32(hdnTotalItem.Value) < Convert.ToInt32(ViewState["MaxCount"])))
        {
