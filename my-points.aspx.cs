...
public partial class my_points : System.Web.UI.Page
{
    ...
    {
        //FCMNotification.Send("Test Title", "Test Body", "100799", "http://dev.skorkel.com/Home.aspx?enc=ZrYx8XicDiRXhY1uFoTEiBl5KTtI/VB0SwArygKKjNU=");
        if (!IsPostBack)
        {
    ...
    protected void LoadPersonalPoint()
    {
        ...
        defactoPoint.InnerText = FinalTotalexpScore.ToString();
        persPoints.InnerText = totalPersonalPt;
        ...
        if (my.responseJson != null)
        {
            try
            {
                if (my.responseJson.issueCount == null)
                    lblIssueCount.Text = "0 Issues";
                else
                    lblIssueCount.Text = (my.responseJson.issueCount == "1") ? "1 Issue" : my.responseJson.issueCount + " Issues";
                ...
                if (my.responseJson.factCount == null)
                    lblFactCount.Text = "0 Facts";                   
                else
                    lblFactCount.Text = (my.responseJson.factCount == "1") ? "1 Fact" : my.responseJson.factCount + " Facts";
                ...
                if (my.responseJson.importantParagraphCount == null)
                    lblImportCount.Text = "0 Important Paragraphs";
                else
                    lblImportCount.Text = (my.responseJson.importantParagraphCount == "1") ? "1 Important Paragraph" : my.responseJson.importantParagraphCount + " Important Paragraphs";
                ...
                if (my.responseJson.orbiterDictumCount == null)
                    lblOrbiterCount.Text = "0 Obiter Dicta";
                else
                    lblOrbiterCount.Text = (my.responseJson.orbiterDictumCount == "1") ? "1 Obiter Dictum" : my.responseJson.orbiterDictumCount + " Obiter Dicta";
                ...
                if (my.responseJson.precedentCount == null)
                    lblPrecedentCount.Text = "0 Precedents";
                else
                    lblPrecedentCount.Text = (my.responseJson.precedentCount == "1") ? "1 Precedent" : my.responseJson.precedentCount + " Precedents";
                ...
                if (my.responseJson.ratioDecidenciCount == null)
                    lblRatioCount.Text = "0 Rationes Decidendi";
                else
                    lblRatioCount.Text = (my.responseJson.ratioDecidenciCount == "1") ? "1 Ratio Decidendi" : my.responseJson.ratioDecidenciCount + " Rationes Decidendi";
                ...
                if (my.responseJson.summaryCount == null)
                    lblSummaryCount.Text = "0 Summaries";
                else
                    lblSummaryCount.Text = (my.responseJson.summaryCount == "1") ? "1 Summary" : my.responseJson.summaryCount + " Summaries";
