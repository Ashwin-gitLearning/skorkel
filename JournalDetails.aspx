<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="JournalDetails.aspx.cs" Inherits="JournalDetails" %>
                        ...
                        <div class="full-width-con journal-con super-admin">
                         ...
                         <div class="super-admin-comp">   
                          <div class="btn-title-con m-t-15-minus">
                            ...
                            <div class="m-download-con ml-2 mt-0 align-items-center d-flex">
                                                ...
                                                <div class="modal-body text-left ">
                                                    <asp:UpdatePanel ID="pnlArt" runat="server">
                                                        ...
                                                        <div class="submit-con">
                                                            ...
                                                            <asp:LinkButton ID="lnkSave" runat="server" CssClass="btn btn-primary hide-body-scroll" ValidationGroup="article" OnClick="lnkSave_Click" OnClientClick="showLoader1();">Submit</asp:LinkButton>
                                                        </div>
                                                            </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                ...
                                <ul class="list-inline download-j d-flex">
                                    <li class="list-inline-item">
                                        
                                        <asp:LinkButton runat="server" ID="lnkDownloadAll" OnClick="lnkDownloadAll_Click" CssClass="d-flex"><span class="lnr lnr-cloud-download hide-ios"></span>&nbsp;<span class="display-none-m">Download All</span></asp:LinkButton>
                                    </li>
                                   
                                </ul>
                                <asp:LinkButton OnClick="lnkAddArticle_Click" ID="lnkAddArticle" runat="server" CssClass="btn btn-outline-primary hide-button-ios  hide-body-scroll ml-2">Add Article</asp:LinkButton>
                                <a href="javascript:void(0);" id="lnkuploadIOS" Class="btn btn-outline-primary hide-body-scroll ml-2">Add Article</a>                              
                                        ...
                                        <div class="list-group-item top-list">
                                            <div class="post-con journal-con">
                                                ...
                                                <span class="more-btn float-right hide-ios">
                                                    ...
                                                    <h3>
                                                        <asp:LinkButton ID="lnkArtTItle" CommandName="ArticleDetails" runat="server" class="user-name title-truncate mb-1" Text='<%#Eval("ArtTitle") %>'></asp:LinkButton>
                                                    </h3>    
