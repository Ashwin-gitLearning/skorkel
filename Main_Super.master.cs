...
public partial class SuperMain : System.Web.UI.MasterPage
{
   ...
   //Renamed and set Breadcrum into the method only
    public void SetBreadcrumb()
    {
        ...
        if (sRet == "SA_NEWSLISTING.aspx" || sRet == "sa_newslisting.aspx")
        {
        ...
        else if (sRet == "SA_JOBSLISTING.aspx" || sRet == "sa_jobslisting.aspx")
        {
            Li_Jobs.Attributes["class"] = "active";            
            sRet = "Jobs";
        }
        else if (sRet == "SA_Notification.aspx" || sRet == "sa_notification.aspx")
        {
            Li_Noti.Attributes["class"] = "active";            
            sRet = "Notifications";
        }        
        else if (sRet == "SA_JOBS-DETAILS.aspx" || sRet == "sa_jobs-details.aspx")
        {
            Li_Jobs.Attributes["class"] = "active";
            mdlBreadCrum1.Style.Add("display", "block");
            lblBread1.Text = "Jobs";
        ...
        else if (sRet == "SA_JOURNALLISTING.aspx" || sRet == "sa_journallisting.aspx")
        {
            Li_Journal.Attributes["class"] = "active";
           // mdlBreadCrum1.Style.Add("display", "block");
            //lblBread1.Text = "Home";            
            sRet = "Journals";
        }
        else if (sRet == "sa_journaldetails.aspx")
        {
            Li_Journal.Attributes["class"] = "active";
            mdlBreadCrum1.Style.Add("display", "block");
        ...
        else if (sRet == "sa_articlelisting.aspx")
        {
            Li_Journal.Attributes["class"] = "active";
            mdlBreadCrum1.Style.Add("display", "block");
            lblBread1.Text = "Journal";
            sRet = "Article Submissions";
        }
        else if (sRet == "SA_ADD-NEWS.aspx" || sRet == "sa_add-news.aspx")
        {
            Li_News.Attributes["class"] = "active";
            mdlBreadCrum1.Style.Add("display", "block");
            lblBread1.Text = "News";
            sRet = "Add News Article";
        }
        else if (sRet == "sa_subdocs.aspx")
        {
            Li_SubDoc.Attributes["class"] = "active";
            //mdlBreadCrum1.Style.Add("display", "block");
            //lblBread1.Text = "News";
            sRet = "Verification Documents";
        }
        else
        {
            sRet = "";
