...
public partial class JournalDetails : System.Web.UI.Page
{
    ...
    protected void lnkSave_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "sshol", "showSuccessPopup('Success','Article added successfuly.');", true);
    }
    private void Clear()
    {
        txtTitle.Text = "";
    ...
    protected void lstArticles_ItemCommand(object sender, System.Web.UI.WebControls.ListViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ArticleDetails.aspx?JrnlId=" + Request.QueryString["JrnlId"] + "&ArtId=" + hdnArticleId.Value);
        }
    ...
    protected void lnkDownloadAll_Click(object sender, EventArgs e)
    {
        ...
        int journalID = Convert.ToInt32(Request.QueryString["JrnlId"]);
