...
IF EXISTS(SELECT 1 FROM Scrl_UserRequestInvitationTbl WHERE (intRegistrationId=@intRegistrationId OR intInvitedUserId=@intRegistrationId) AND IsAccepted=1)                                          
 BEGIN                                          
  ...
  FROM(                                          
   ...
   (SELECT vchrFirstName +' '+ ISNULL(vchrLastName,'') NAME From scrl_RegistrationTbl WHERE intRegistrationId=intInvitedUserId) Name,                                            
    (SELECT vchrPhotoPath From scrl_RegistrationTbl WHERE intRegistrationId=intInvitedUserId) vchrPhotoPath,                         CONVERT(VARCHAR(12),dtReqAcceptedDate,106) dtReqAcceptedDate,                                               
...
BEGIN                                          
 ...
 (                                           
  ...
  union ALL                    
  SELECT @intRegistrationId as Id, @intRegistrationId as intRegistrationId, '' as intInvitedUserId, '' as strInvitee,(SUBSTRING ( SCL_SA_Notifications.notification_detail ,0 , 50 )+CASE WHEN LEN(SCL_SA_Notifications.notification_detail)>50 THEN '...' ELSE
 '' END)strGroupName,'' StrRecommendation,  '' as Name,'' as vchrPhotoPath,'' as vchrUserName,                     
...
BEGIN                      
  ...
  (                       
   ...
   AND (IsAccepted='0' or IsAccepted = '1')                  
   AND Scrl_UserGroupDetailTbl.strAccess='R'   
   ...
   --  LEFT OUTER JOIN scrl_RegistrationTbl ON Scrl_UserGroupJoiningTbl.intAddedby=scrl_RegistrationTbl.intRegistrationId                      
   --  LEFT OUTER JOIN Scrl_UserGroupDetailTbl ON Scrl_UserGroupDetailTbl.inGroupId=Scrl_UserGroupJoiningTbl.inGroupId                            
   --WHERE Scrl_UserGroupJoiningTbl.intInvitedUserId=100844                       
   --AND (IsAccepted='1')                      
   --AND Scrl_UserGroupDetailTbl.strAccess='R'
...
BEGIN                      
 SELECT * FROM (                      
  SELECT                       
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserRequestInvitationTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserRequestInvitationTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                          
    CASE WHEN IsAccepted='0' THEN  '<span style="color:orange;">Pending</span>'                      
      WHEN IsAccepted='1' THEN  '<span style="color:Green;">Accepted</span>'                       
      WHEN IsAccepted='2' THEN  '<span style="color:Red;">Cancelled</span>'                         
    ELSE '' END                       
  ...
  SELECT intRecommendationId Id,Scrl_UserRecommendationTbl.intRegistrationId,intInvitedUserId,'' strInvitee,'' strGroupName,                      
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserRecommendationTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserRecommendationTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                 
    CASE WHEN IsAccepted='0' THEN  '<span style="color:orange;">Pending</span>'                      
      WHEN IsAccepted='1' THEN  '<span style="color:Green;">Accepted</span>'                       
      WHEN IsAccepted='2' THEN  '<span style="color:Red;">Cancelled</span>'                         
    ELSE '' END                       
  ...
  SELECT                         
   ...
   ORDER BY dtAddedOn desc,dtModifiedOn desc) Designation,                      
    ...
    STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserGroupJoiningTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserGroupJoiningTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                           
    CASE WHEN IsAccepted='0' THEN  '<span style="color:orange;">Pending</span>'                      
      WHEN IsAccepted='1' THEN  '<span style="color:Green;">Accepted</span>'                       
      WHEN IsAccepted='2' THEN  '<span style="color:Red;">Cancelled</span>'                         
    ELSE '' END                       
 ...
 STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_GroupMemberDetailsTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_GroupMemberDetailsTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                    
  ...
  SELECT                       
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_GroupShareTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_GroupShareTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                      
  ...
  SELECT                       
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserPostQAReplyTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_UserPostQAReplyTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                       
  ...
  SELECT                       
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_BlogHeadingLikeShareTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_BlogHeadingLikeShareTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,        
...
Scrl_BlogHeadingLikeShareTbl.strMessage AS strMessage, Scrl_BlogHeadingLikeShareTbl.strLink AS strLink,'' AS IsAccept,' ' AS intIsAccept                                    
  ...
  Select Notification_ID as Id, 0 as intRegistrationId, 0 as intInvitedUserId,  '' as strInviteeShare,Notification_Detail as strGroupName,  '' StrRecommendation,  '' as Name,'' as vchrPhotoPath,'' as vchrUserName, '' as intUserTypeID,                    
   ...
   '' as Designation, '' as dtReqAcceptedDate,dateAddedOn,'SCL_SA_Notifications' as strTableName,   
   --LTRIM(RIGHT(CONVERT(VARCHAR(20), SCL_SA_Notifications.dateaddedon, 100), 7)) AddedTime,  
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), SCL_SA_Notifications.dateaddedon, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), SCL_SA_Notifications.dateaddedon, 100), 7))) - 1, 0,' ') AddedTime,  
   '' as IsAccepted,dateaddedon as dtAdded, '' as strMessage,'' as strLink,'' as IsAccept,' ' AS intIsAccept                                        
  ...
  SELECT                       
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_MicrolTagLikeShareTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_MicrolTagLikeShareTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                      
  ...
  WHERE                       
   ...
   STUFF(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_GrpUserStatusUpdateTbl.dtAddedOn, 100), 7)),  
    LEN(LTRIM(RIGHT(CONVERT(VARCHAR(20), Scrl_GrpUserStatusUpdateTbl.dtAddedOn, 100), 7))) - 1, 0,' ') AddedTime,                   
